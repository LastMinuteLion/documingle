...
const ShareModal = ({roomId,collaborators,creatorId,currentUserType}:ShareDocumentDialogProps) => {
    ...
    return (
        ...
        <DialogContent className="shad-dialog">
          <DialogHeader>
            <DialogTitle>Who can view this document</DialogTitle>
            <DialogDescription>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button type = "submit" onClick={sharedDocumentHandler} className="
            gradient-blue flex h-full gap-1 px-5" disabled={loading}>
