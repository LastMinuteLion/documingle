    ...
    try {
        ...
        if(room){
            ...
            await liveblocks.triggerInboxNotification({
                ...
                activityData:{
                    userType,
                    title: `You have been granted ${userType} access to the document by
                    ${updatedBy.name} `,
        ...
        console.log(`Error updating document access or room access: ${error}`);
    }
}


export const removeCollaborator = async({roomId, email}: {roomId:
     string, email: string}) =>{
